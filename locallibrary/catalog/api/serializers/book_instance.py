...
class BorrowOrReserveSerializer(BookInstanceStatusDueBackValidationMixin, serializers.Serializer):
    STATUS_CHOICES = (
...
class ChangeStatusSerializer(BookInstanceStatusDueBackValidationMixin, serializers.ModelSerializer):
    class Meta:
        model = BookInstance
