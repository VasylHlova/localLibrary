    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('due_back', models.DateField(blank=True, help_text='Date when book should become avaliable', null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(help_text='Enter a book genre (e.g. Scince Fiction, French Poetry etc.)', max_length=200, unique=True)),
            ],
        ),
        migrations.CreateModel(
            name='Language',
